...
fn get_text_input(key_code: KeyCode, text_buffer: &mut String) -> bool {
	match key_code {
...
fn get_enter_press(key_code: KeyCode) -> bool {
...
fn evaluate_yes_no_answer(key_code: KeyCode) -> Option<bool> {
	match key_code {
		KeyCode::Char(c) => {
